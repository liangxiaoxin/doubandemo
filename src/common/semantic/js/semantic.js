...
$.fn.form.settings = {
  ...
  error: {
    ...
    oldSyntax  : 'Starting in 2.0 forms now only take a single settings object. Validation settings converted to newmovie syntax automatically.'
  },
        ...
        add: {
          ...
          userSuggestion: function(value) {
            ...
            if(hasUserSuggestion) {
              ...
              module.verbose('Replacing user suggestion with newmovie value', $addition);
            }
            else {
          ...
          position: function(position, calculations) {
            ...
            if( module.is.offstage(distanceFromBoundary, position) ) {
              ...
              if(searchDepth < settings.maxSearchDepth) {
                ...
                module.debug('Trying newmovie position', position);
                return ($popup)
...
$.fn.popup.settings = {
  ...
  // position to prefer when calculating newmovie position
  prefer         : 'opposite',
        ...
        set: {
          ...
          progress: function(value) {
            if(!module.has.progressPoll()) {
              ...
              module.debug('Updated within interval, setting next update to use newmovie value', value);
    ...
    .each(function() {
      ...
      module = {
        ...
        set: {
          ...
          active: function() {
            module.verbose('Setting newmovie side to active', $nextSide);
            $side
              .removeClass(className.active)
            ;
            $nextSide
...
$.fn.tab.settings = {
  ...
  alwaysRefresh   : false,      // load tab content newmovie every tab click
...
$.fn.transition.settings = {
  ...
  // newmovie animations will occur after previous ones
  queue         : true,
...
$.api.settings = {
  ...
  // whether newmovie requests should abort previous requests
